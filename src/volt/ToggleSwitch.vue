...
const theme = ref<ToggleSwitchPassThroughOptions>({
    root: `relative inline-block w-10 h-6`,
    input: `peer cursor-pointer appearance-none absolute top-0 left-0 w-full h-full m-0 p-0 opacity-0 z-10`,
    ...
    handle: `absolute top-1/2 flex justify-center items-center
        ...
        p-checked:bg-surface-0 dark:p-checked:bg-surface-900 p-checked:text-primary p-checked:left-5
